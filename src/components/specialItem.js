...
export class SpecialItem extends React.Component {
    ...
    render() {
        if (this.props.food.price > 17) {
            return (

                <>
                    <Card style={{ width: '100%', verticalAlign: "middle", margin: 'auto', border: '2px' }}>
            ...
            return (
                <div style={{ color: 'white', backgroundColor: '#A47551' }}>
